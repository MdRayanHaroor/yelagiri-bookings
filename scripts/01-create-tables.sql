...
CREATE TABLE hotels (
    ...
    category_id UUID REFERENCES hotel_categories(id),
    
    -- Location details
    address TEXT NOT NULL,
    latitude DECIMAL(10, 8),
    longitude DECIMAL(11, 8),
    area VARCHAR(100), -- e.g., "Yelagiri Hills Center", "Lake View Area"
...
CREATE TABLE hotel_images (
    ...
    image_type VARCHAR(50) DEFAULT 'general', -- 'primary', 'room', 'amenity', 'exterior', 'interior'
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE amenities (
    ...
    description TEXT,
    icon VARCHAR(50),
    category VARCHAR(50), -- 'basic', 'premium', 'business', 'recreation', 'accessibility'
...
CREATE TABLE hotel_policies (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    hotel_id UUID REFERENCES hotels(id) ON DELETE CASCADE,
    policy_type VARCHAR(50) NOT NULL, -- 'cancellation', 'pet', 'smoking', 'child', 'payment'
...
CREATE INDEX idx_hotels_location ON hotels(area);
